...
function setProfileInSession(profileItem) {
    ...
    fetch('/api/set_profile?profile_id='+profileItem.value, {
        ...
        .then(async response => {
            ...
            const url = 'https://allegro.pl/auth/oauth/authorize?response_type=code&client_id='+data.profile.clientId+'&redirect_uri=https://localhost:8000/allAuth&promt=none'
